            ...
            <tbody>
              {logs.map((log) => (
                <tr key={log.ID} className="border-b border-gray-800/50 hover:bg-gray-900/50">
                  <td className="py-2 px-3 text-xs text-gray-400">{formatDate(log.Timestamp)}</td>
                  <td className="py-2 px-3">#{log.TorrentID}</td>
                  <td className="py-2 px-3 text-xs text-gray-400 truncate max-w-[200px]">{log.TrackerURL}</td>
                  ...
                  <td className="py-2 px-3 text-center text-gray-400">{log.Leechers}/{log.Seeders}</td>
                  <td className="py-2 px-3 text-center text-gray-400">{log.IntervalSecs}s</td>
